...
SELECT 
    Cliente.codigo AS id_cliente,
    Cliente.nome AS nome_cliente,
    Cliente.sobreNome,
    Cliente.cpf,
    Cliente.telefone,
    LimiteDeCredito.nome AS limite_credito,
    Endereco.logradouro,
    Endereco.numero,
    Endereco.cep,
    Endereco.cidade
FROM Cliente
INNER JOIN LimiteDeCredito ON Cliente.id_limite = LimiteDeCredito.id_limite
...
SELECT 
    ...
    Cliente.codigo AS id_cliente,
    Cliente.nome AS nome_cliente,
    Produto.codigo AS id_produto,
    Produto.nome AS nome_produto,
    Produto.preco
FROM Pedido
INNER JOIN Cliente ON Pedido.id_cliente = Cliente.codigo
